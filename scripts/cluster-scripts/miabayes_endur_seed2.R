...
write.csv(endurmod2.mcmc, file="results/run2/endur_fullmod_mcmc_out.csv")
write.csv(endurmod2poly.mcmc, file="results/run2/endur_reducemod_mcmc_out.csv")
...
sink("results/run2/endur_summ_model1.txt")
print(endurmodel1out)
sink()
endurmode1 <- posterior.mode(bendmodel1$VCV)
write.csv(endurmode1, file="results/run2/endur_mode_1.csv")
endurautocor1 <- autocorr.diag(bendmodel1$VCV)
write.csv(endurautocor1, file="results/run2/endur_autocorr_VCV1.csv")
endurheidelrout1 <- heidel.diag(bendmodel1$VCV)
write.csv(endurheidelrout1, file="results/run2/endur_heidelrout_1.csv")
endurheidelfout1 <- heidel.diag(bendmodel1$Sol)
write.csv(endurheidelfout1, file="results/run2/endur_heidelfout_1.csv")
write.csv(rbind(HPDinterval(bendmodel1$Sol), HPDinterval(bendmodel1$VCV)), file="results/run2/endur_hpds_model1")

#Model 2 Output
write.csv(m2sum, file="results/run2/endur_fullmod_summary.csv")
write.csv(polysum, file="results/run2/endur_reducemod_summary.csv")

write.csv(dicscore, file="results/run2/endur_dics.csv")

write.csv(heidelfout, file="results/run2/endur_heidelfout_longrun.csv")
write.csv(heidelrout, file="results/run2/endur_heidelrout_longrun.csv")
write.csv(autofix, file="results/run2/endur_autocorr_fix_longrun.csv")
write.csv(autorand, file="results/run2/endur_autocorr_rand_longrun.csv")

write.csv(polyheidelfout, file="results/run2/poly_endur_heidelfout_longrun.csv")
write.csv(polyheidelrout, file="results/run2/poly_endur_heidelrout_longrun.csv")
write.csv(polyautofix, file="results/run2/poly_endur_autocorr_fix_longrun.csv")
write.csv(polyautorand, file="results/run2/poly_endur_autocorr_rand_longrun.csv")
