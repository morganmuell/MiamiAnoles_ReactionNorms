...
write.csv(wumod2.mcmc, file="results/run2/fullmod_mcmc_out.csv")
write.csv(wumod2poly.mcmc, file="results/run2/reducemod_mcmc_out.csv")
...
sink("results/run2/wu_summ_model1.txt")
print(wumodel1out)
sink()
wumode1 <- posterior.mode(bwumodel1$VCV)
write.csv(wumode1, file="results/run2/wu_mode_1.csv")
wuautocor1 <- autocorr.diag(bwumodel1$VCV)
write.csv(wuautocor1, file="results/run2/wu_autocorr_VCV1.csv")
wuheidelrout1 <- heidel.diag(bwumodel1$VCV)
write.csv(wuheidelrout1, file="results/run2/wu_heidelrout_1.csv")
wuheidelfout1 <- heidel.diag(bwumodel1$Sol)
write.csv(wuheidelfout1, file="results/run2/wu_heidelfout_1.csv")
write.csv(rbind(HPDinterval(bwumodel1$Sol), HPDinterval(bwumodel1$VCV)), file="results/run2/wu_hpds_model1")

#Model 2 Output
write.csv(m2sum, file="results/run2/fullmod_summary.csv")
write.csv(polysum, file="results/run2/reducemod_summary.csv")

write.csv(dicscore, file="results/run2/wu_dics.csv")

write.csv(heidelfout, file="results/run2/wu_heidelfout_longrun.csv")
write.csv(heidelrout, file="results/run2/wu_heidelrout_longrun.csv")
write.csv(autofix, file="results/run2/wu_autocorr_fix_longrun.csv")
write.csv(autorand, file="results/run2/wu_autocorr_rand_longrun.csv")


write.csv(polyheidelfout, file="results/run2/poly_wu_heidelfout_longrun.csv")
write.csv(polyheidelrout, file="results/run2/poly_wu_heidelrout_longrun.csv")
write.csv(polyautofix, file="results/run2/poly_wu_autocorr_fix_longrun.csv")
write.csv(polyautorand, file="results/run2/poly_wu_autocorr_rand_longrun.csv")
