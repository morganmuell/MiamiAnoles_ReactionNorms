...
while(cg < length(devs)+1){
  ...
  #grab ESS objects
  fullsum <- summary(bendmodel2)
  polysum <- summary(bendmodel2poly)
...
##--export results
write.csv(fullessvals, file="results/run1/fullmod_ess.csv")
write.csv(redessvals, file="results/run1/polymod_ess.csv")
