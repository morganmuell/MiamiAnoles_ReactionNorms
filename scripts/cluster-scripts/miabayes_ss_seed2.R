...
write.csv(ssmod2.mcmc, file="results/run2/ss_fullmod_mcmc_out.csv")
write.csv(ssmod2poly.mcmc, file="results/run2/ss_reducemod_mcmc_out.csv")
...
sink("results/run2/ss_summ_model1.txt")
print(ssmodel1out)
sink()
ssmode1 <- posterior.mode(bssmodel1$VCV)
write.csv(ssmode1, file="results/run2/ss_mode_1.csv")
ssautocor1 <- autocorr.diag(bssmodel1$VCV)
write.csv(ssautocor1, file="results/run2/ss_autocorr_VCV1.csv")
ssheidelrout1 <- heidel.diag(bssmodel1$VCV)
write.csv(ssheidelrout1, file="results/run2/ss_heidelrout_1.csv")
ssheidelfout1 <- heidel.diag(bssmodel1$Sol)
write.csv(ssheidelfout1, file="results/run2/ss_heidelfout_1.csv")
write.csv(rbind(HPDinterval(bssmodel1$Sol), HPDinterval(bssmodel1$VCV)), file="results/run2/ss_hpds_model1")

#Model 2 Output
write.csv(m2sum, file="results/run2/ss_fullmod_summary.csv")
write.csv(polysum, file="results/run2/ss_reducemod_summary.csv")

write.csv(dicscore, file="results/run2/ss_dics.csv")

write.csv(heidelfout, file="results/run2/ss_heidelfout_longrun.csv")
write.csv(heidelrout, file="results/run2/ss_heidelrout_longrun.csv")
write.csv(autofix, file="results/run2/ss_autocorr_fix_longrun.csv")
write.csv(autorand, file="results/run2/ss_autocorr_rand_longrun.csv")

write.csv(polyheidelfout, file="results/run2/poly_ss_heidelfout_longrun.csv")
write.csv(polyheidelrout, file="results/run2/poly_ss_heidelrout_longrun.csv")
write.csv(polyautofix, file="results/run2/poly_ss_autocorr_fix_longrun.csv")
write.csv(polyautorand, file="results/run2/poly_ss_autocorr_rand_longrun.csv")
