...
write.csv(incmod2.mcmc, file="results/run2/inc_fullmod_mcmc_out.csv")
write.csv(incmod2poly.mcmc, file="results/run2/inc_reducemod_mcmc_out.csv")
...
sink("results/run2/inc_summ_model1.txt")
print(incmodel1out)
sink()
incmode1 <- posterior.mode(bincmodel1$VCV)
write.csv(incmode1, file="results/run2/inc_mode_1.csv")
incautocor1 <- autocorr.diag(bincmodel1$VCV)
write.csv(incautocor1, file="results/run2/inc_autocorr_VCV1.csv")
incheidelrout1 <- heidel.diag(bincmodel1$VCV)
write.csv(incheidelrout1, file="results/run2/inc_heidelrout_1.csv")
incheidelfout1 <- heidel.diag(bincmodel1$Sol)
write.csv(incheidelfout1, file="results/run2/inc_heidelfout_1.csv")
write.csv(rbind(HPDinterval(bincmodel1$Sol), HPDinterval(bincmodel1$VCV)), file="results/run2/inc_hpds_model1")

#Model 2 Output
write.csv(m2sum, file="results/run2/inc_fullmod_summary.csv")
write.csv(polysum, file="results/run2/inc_reducemod_summary.csv")

write.csv(dicscore, file="results/run2inc_dics.csv")

write.csv(heidelfout, file="results/run2/inc_heidelfout_longrun.csv")
write.csv(heidelrout, file="results/run2/inc_heidelrout_longrun.csv")
write.csv(autofix, file="results/run2/inc_autocorr_fix_longrun.csv")
write.csv(autorand, file="results/run2/inc_autocorr_rand_longrun.csv")

write.csv(polyheidelfout, file="results/run2/poly_inc_heidelfout_longrun.csv")
write.csv(polyheidelrout, file="results/run2/poly_inc_heidelrout_longrun.csv")
write.csv(polyautofix, file="results/run2/poly_inc_autocorr_fix_longrun.csv")
write.csv(polyautorand, file="results/run2/poly_inc_autocorr_rand_longrun.csv")
